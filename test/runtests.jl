...
# !!! Main.UserApp is configured as an alias for Main.TempApp and you might encounter it in some tests
using Main.TempApp, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "TempApp tests" begin
  @includetests ARGS
end
